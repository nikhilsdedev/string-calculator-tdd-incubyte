...
[![Flutter](https://img.shields.io/badge/Flutter-3.32.2-02569B.svg)](https://flutter.dev)
...
```
string_calculator_tdd_incubyte/
├── lib/
│   └── string_calculator_tdd_incubyte.dart    # Main implementation (36 lines)
├── test/
│   └── string_calculator_tdd_incubyte_test.dart   # Unit tests (14 test)
├── pubspec.yaml
...
# Navigate to project
cd string_calculator_tdd_incubyte
